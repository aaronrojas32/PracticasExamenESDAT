...
public class ArbolEmpleado {
    ...
    /**
     * Da de alta un empleado bajo un supervisor dado.
     * Si supervisor es null, intenta establecer al empleado como CEO.
     * @param supervisor Nombre del supervisor (null para CEO).
